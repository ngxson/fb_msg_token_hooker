...
.field private o:Lcom/facebook/orca/threads/ThreadSummary;

.field private p:Lcom/facebook/orca/users/User;
...
.method private m()Lcom/facebook/orca/activity/ConfirmActionParams;
    .locals 5
    ...
    .line 46
    sget v1, Lcom/facebook/R$string;->thread_remove_member_confirm_heading:I
    ...
    .line 47
    sget v1, Lcom/facebook/R$string;->thread_remove_member_confirm_msg:I
    ...
    iget-object v4, p0, Lcom/facebook/orca/mutators/RemoveMemberActivity;->p:Lcom/facebook/orca/users/User;
    ...
    .line 49
    sget v1, Lcom/facebook/R$string;->thread_remove_member_confirm_ok_button:I
...
.method private n()V
    ...
    .prologue
    .line 97
    iget-object v0, p0, Lcom/facebook/orca/mutators/RemoveMemberActivity;->q:Lcom/facebook/orca/ops/OrcaServiceFragment;
    ...
    iget-object v1, p0, Lcom/facebook/orca/mutators/RemoveMemberActivity;->o:Lcom/facebook/orca/threads/ThreadSummary;

    invoke-virtual {v1}, Lcom/facebook/orca/threads/ThreadSummary;->a()Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lcom/facebook/orca/mutators/RemoveMemberActivity;->p:Lcom/facebook/orca/users/User;
...
.method protected a(Landroid/os/Bundle;)V
    ...
    .line 58
    invoke-virtual {p0}, Lcom/facebook/orca/mutators/RemoveMemberActivity;->l()Lcom/facebook/orca/inject/FbInjector;
    ...
    iput-object v0, p0, Lcom/facebook/orca/mutators/RemoveMemberActivity;->n:Lcom/facebook/orca/cache/DataCache;
    ...
    .line 66
    iget-object v2, p0, Lcom/facebook/orca/mutators/RemoveMemberActivity;->n:Lcom/facebook/orca/cache/DataCache;

    invoke-virtual {v2, v1}, Lcom/facebook/orca/cache/DataCache;->b(Ljava/lang/String;)Lcom/facebook/orca/threads/ThreadSummary;

    move-result-object v1

    iput-object v1, p0, Lcom/facebook/orca/mutators/RemoveMemberActivity;->o:Lcom/facebook/orca/threads/ThreadSummary;

    .line 67
    iget-object v1, p0, Lcom/facebook/orca/mutators/RemoveMemberActivity;->n:Lcom/facebook/orca/cache/DataCache;

    invoke-virtual {v1, v0}, Lcom/facebook/orca/cache/DataCache;->a(Lcom/facebook/orca/users/UserKey;)Lcom/facebook/orca/users/User;

    move-result-object v0

    iput-object v0, p0, Lcom/facebook/orca/mutators/RemoveMemberActivity;->p:Lcom/facebook/orca/users/User;

    .line 68
    iget-object v0, p0, Lcom/facebook/orca/mutators/RemoveMemberActivity;->o:Lcom/facebook/orca/threads/ThreadSummary;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/facebook/orca/mutators/RemoveMemberActivity;->p:Lcom/facebook/orca/users/User;
    ...
    .line 73
    :cond_1
    invoke-direct {p0}, Lcom/facebook/orca/mutators/RemoveMemberActivity;->m()Lcom/facebook/orca/activity/ConfirmActionParams;
    ...
    iput-object v0, p0, Lcom/facebook/orca/mutators/RemoveMemberActivity;->q:Lcom/facebook/orca/ops/OrcaServiceFragment;
    ...
    sget v2, Lcom/facebook/R$string;->thread_remove_member_progress:I
