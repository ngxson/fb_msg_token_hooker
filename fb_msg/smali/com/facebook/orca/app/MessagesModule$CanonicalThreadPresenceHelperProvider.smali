...
.method public a()Lcom/facebook/orca/users/CanonicalThreadPresenceHelper;
    ...
    invoke-virtual {p0, v2}, Lcom/facebook/orca/app/MessagesModule$CanonicalThreadPresenceHelperProvider;->b(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/facebook/orca/presence/PresenceManager;

    const-class v3, Lcom/facebook/orca/cache/DataCache;

    invoke-virtual {p0, v3}, Lcom/facebook/orca/app/MessagesModule$CanonicalThreadPresenceHelperProvider;->b(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v4}, Lcom/facebook/orca/app/MessagesModule$CanonicalThreadPresenceHelperProvider;->b(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Lcom/facebook/orca/cache/ThreadDisplayCache;

    const-class v5, Lcom/facebook/orca/users/LastActiveHelper;

    invoke-virtual {p0, v5}, Lcom/facebook/orca/app/MessagesModule$CanonicalThreadPresenceHelperProvider;->b(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lcom/facebook/orca/users/LastActiveHelper;

    const-class v6, Landroid/content/res/Resources;

    invoke-virtual {p0, v6}, Lcom/facebook/orca/app/MessagesModule$CanonicalThreadPresenceHelperProvider;->b(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Landroid/content/res/Resources;

    invoke-direct/range {v0 .. v6}, Lcom/facebook/orca/users/CanonicalThreadPresenceHelper;-><init>(Lcom/facebook/orca/threads/ThreadParticipantUtils;Lcom/facebook/orca/presence/PresenceManager;Lcom/facebook/orca/cache/DataCache;Lcom/facebook/orca/cache/ThreadDisplayCache;Lcom/facebook/orca/users/LastActiveHelper;Landroid/content/res/Resources;)V
