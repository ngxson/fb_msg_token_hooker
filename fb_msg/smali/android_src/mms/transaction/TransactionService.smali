...
.field private b:Landroid_src/mms/transaction/TransactionService$ServiceHandler;
...
.field private final d:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "<",
            "Landroid_src/mms/transaction/Transaction;",
            ">;"
        }
    .end annotation
.end field
...
.field private g:Landroid_src/mms/transaction/TransactionService$ConnectivityBroadcastReceiver;
...
.method public constructor <init>()V
    ...
    .line 136
    new-instance v0, Landroid_src/mms/transaction/TransactionService$1;

    invoke-direct {v0, p0}, Landroid_src/mms/transaction/TransactionService$1;-><init>(Landroid_src/mms/transaction/TransactionService;)V
...
.method private a(I)V
    ...
    invoke-static {v0}, Landroid_src/mms/transaction/MmsSystemEventReceiver;->b(Landroid/content/Context;)V
...
.method private a(ILandroid_src/mms/transaction/TransactionBundle;Z)V
    .locals 4
    .parameter
    .parameter
    .parameter
    ...
    .line 318
    invoke-virtual {p2}, Landroid_src/mms/transaction/TransactionBundle;->a()I
    ...
    .line 321
    :cond_0
    iget-object v0, p0, Landroid_src/mms/transaction/TransactionService;->b:Landroid_src/mms/transaction/TransactionService$ServiceHandler;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid_src/mms/transaction/TransactionService$ServiceHandler;->obtainMessage(I)Landroid/os/Message;
    ...
    .line 328
    :cond_1
    iget-object v1, p0, Landroid_src/mms/transaction/TransactionService;->b:Landroid_src/mms/transaction/TransactionService$ServiceHandler;

    invoke-virtual {v1, v0}, Landroid_src/mms/transaction/TransactionService$ServiceHandler;->sendMessage(Landroid/os/Message;)Z
...
.method static synthetic d(Landroid_src/mms/transaction/TransactionService;)Landroid_src/mms/transaction/TransactionService$ServiceHandler;
    .locals 1
    .parameter
...
.method private g()V
    ...
    invoke-virtual {v1, v2}, Landroid_src/mms/transaction/TransactionService$ServiceHandler;->obtainMessage(I)Landroid/os/Message;

    move-result-object v1

    const-wide/16 v2, 0x7530

    invoke-virtual {v0, v1, v2, v3}, Landroid_src/mms/transaction/TransactionService$ServiceHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method public a(Landroid_src/mms/transaction/Observable;)V
    ...
    .line 374
    check-cast p1, Landroid_src/mms/transaction/Transaction;
    ...
    invoke-virtual {p1}, Landroid_src/mms/transaction/Transaction;->f()Landroid_src/mms/transaction/TransactionSettings;

    move-result-object v4

    invoke-virtual {v0, v3, v4}, Landroid_src/mms/transaction/TransactionService$ServiceHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v0

    .line 391
    iget-object v3, p0, Landroid_src/mms/transaction/TransactionService;->b:Landroid_src/mms/transaction/TransactionService$ServiceHandler;

    invoke-virtual {v3, v0}, Landroid_src/mms/transaction/TransactionService$ServiceHandler;->sendMessage(Landroid/os/Message;)Z
    ...
    .line 402
    invoke-virtual {p1}, Landroid_src/mms/transaction/Transaction;->d()Landroid_src/mms/transaction/TransactionState;
    ...
    invoke-static {v2, v4}, Lcom/facebook/orca/debug/BLog;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 447
    invoke-virtual {p1, p0}, Landroid_src/mms/transaction/Transaction;->b(Landroid_src/mms/transaction/Observer;)V
    ...
    invoke-static {v2}, Landroid_src/mms/transaction/MmsSystemEventReceiver;->b(Landroid/content/Context;)V
    ...
    .line 414
    :cond_6
    invoke-virtual {p1}, Landroid_src/mms/transaction/Transaction;->b()I
    ...
    invoke-static {p0, v2, v4}, Landroid_src/mms/transaction/MessagingNotification;->b(Landroid/content/Context;ZZ)V

    .line 421
    invoke-static {p0}, Landroid_src/mms/transaction/MessagingNotification;->b(Landroid/content/Context;)V

    goto/16 :goto_1

    .line 424
    :pswitch_2
    invoke-static {}, Landroid_src/mms/util/RateController;->a()Landroid_src/mms/util/RateController;

    move-result-object v2

    invoke-virtual {v2}, Landroid_src/mms/util/RateController;->b()V
...
.method protected b()V
    ...
    invoke-virtual {v0, v1}, Landroid_src/mms/transaction/TransactionService$ServiceHandler;->removeMessages(I)V
...
.method public onCreate()V
    ...
    .line 167
    new-instance v0, Landroid_src/mms/transaction/TransactionService$ServiceHandler;

    iget-object v1, p0, Landroid_src/mms/transaction/TransactionService;->c:Landroid/os/Looper;

    invoke-direct {v0, p0, v1}, Landroid_src/mms/transaction/TransactionService$ServiceHandler;-><init>(Landroid_src/mms/transaction/TransactionService;Landroid/os/Looper;)V

    iput-object v0, p0, Landroid_src/mms/transaction/TransactionService;->b:Landroid_src/mms/transaction/TransactionService$ServiceHandler;

    .line 169
    new-instance v0, Landroid_src/mms/transaction/TransactionService$ConnectivityBroadcastReceiver;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Landroid_src/mms/transaction/TransactionService$ConnectivityBroadcastReceiver;-><init>(Landroid_src/mms/transaction/TransactionService;Landroid_src/mms/transaction/TransactionService$1;)V

    iput-object v0, p0, Landroid_src/mms/transaction/TransactionService;->g:Landroid_src/mms/transaction/TransactionService$ConnectivityBroadcastReceiver;
    ...
    .line 172
    iget-object v1, p0, Landroid_src/mms/transaction/TransactionService;->g:Landroid_src/mms/transaction/TransactionService$ConnectivityBroadcastReceiver;
...
.method public onDestroy()V
    ...
    .line 359
    iget-object v0, p0, Landroid_src/mms/transaction/TransactionService;->g:Landroid_src/mms/transaction/TransactionService$ConnectivityBroadcastReceiver;
    ...
    invoke-virtual {v0, v1}, Landroid_src/mms/transaction/TransactionService$ServiceHandler;->sendEmptyMessage(I)Z
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    invoke-static {v3, v1}, Lcom/facebook/orca/debug/BLog;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2, v3}, Landroid_src/mms/pdu/PduPersister;->a(J)Landroid/database/Cursor;
    ...
    .line 204
    :cond_4
    invoke-static {p0}, Landroid_src/mms/transaction/RetryScheduler;->b(Landroid/content/Context;)V
    ...
    invoke-static {v4}, Landroid_src/mms/transaction/MmsSystemEventReceiver;->a(Landroid/content/Context;)V
    ...
    .line 247
    new-instance v6, Landroid_src/mms/transaction/TransactionBundle;

    invoke-virtual {v5}, Landroid/net/Uri;->toString()Ljava/lang/String;

    move-result-object v5

    invoke-direct {v6, v4, v5}, Landroid_src/mms/transaction/TransactionBundle;-><init>(ILjava/lang/String;)V

    .line 250
    const/4 v4, 0x0

    invoke-direct {p0, p3, v6, v4}, Landroid_src/mms/transaction/TransactionService;->a(ILandroid_src/mms/transaction/TransactionBundle;Z)V
    :try_end_2
    ...
    .line 269
    :cond_10
    new-instance v1, Landroid_src/mms/transaction/TransactionBundle;

    invoke-virtual {p1}, Landroid/content/Intent;->getExtras()Landroid/os/Bundle;

    move-result-object v2

    invoke-direct {v1, v2}, Landroid_src/mms/transaction/TransactionBundle;-><init>(Landroid/os/Bundle;)V

    .line 270
    invoke-direct {p0, p3, v1, v0}, Landroid_src/mms/transaction/TransactionService;->a(ILandroid_src/mms/transaction/TransactionBundle;Z)V
